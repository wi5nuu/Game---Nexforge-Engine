...
impl LspServer {
    ...
    pub fn completions(&self, uri: &str, line: usize, _column: usize) -> Vec<CompletionItem> {
        ...
        let builtins = [
            ...
            ("raycast", "Cast a ray and get hit info", CompletionItemKind::Function),
            ("find_entity", "Find entity by name", CompletionItemKind::Function),
            ("spawn_entity", "Spawn a new entity", CompletionItemKind::Function),
            ("play_sound", "Play a sound effect", CompletionItemKind::Function),
            ("show_ui", "Show a UI element", CompletionItemKind::Function),
            ("hide_ui", "Hide a UI element", CompletionItemKind::Function),
            ("entities_with", "Query entities with components", CompletionItemKind::Function),
        ];
