...
impl BloomPass {
    pub fn new() -> Self { Self { intensity: 0.5, threshold: 1.0, radius: 0.005, mip_count: 5 } }
    pub fn apply(&self, color: [f32; 3]) -> [f32; 3] {
...
impl SSAOPass {
    pub fn new() -> Self { Self { enabled: true, radius: 0.5, bias: 0.025, power: 1.0, sample_count: 16 } }
}
...
impl MotionBlurPass {
    pub fn new() -> Self { Self { enabled: false, samples: 8, strength: 0.5 } }
}

impl Default for MotionBlurPass { fn default() -> Self { Self::new() } }
...
impl Default for PostProcessStack { fn default() -> Self { Self::new() } }
